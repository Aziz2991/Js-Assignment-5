...
// // Quest 08
let studentss = ['Michael','John','Tony']
let scores = [320,230,480];
let totalMarks = 500;
for(let i = 0; i < studentss.length; i ++){let percentage = (scores[i]/totalMarks)*100;
   document.write(`Scores of ${studentss[i]} is ${scores[i]}.Percentage: ${percentage}%<br>`)
}
